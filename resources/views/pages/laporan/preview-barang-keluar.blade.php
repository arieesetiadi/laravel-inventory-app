...
@section('content')
    <div class="container">
            ...
            <div class="col">
                <div class="page-description d-flex align-items-center">
                    <div class="page-description-content flex-grow-1">
                        <h1>Preview Laporan Barang Keluar</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form action="{{ route('previewBarangKeluar') }}" method="GET" class="card-header d-flex gap-5">
                    ...
                    <form target="_blank" action="{{ route('cetakBarangKeluar') }}" method="GET" class="card-footer">
