    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <form id="tambah-stok-barang-form" action="{{ route('prosesTambahStokBarang') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input maxlength="100" name="jumlah" type="number" class="form-control" id="jumlah"
                                    aria-describedby="jumlah" placeholder="Masukan jumlah stok barang" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input maxlength="100" name="satuan" type="text" class="form-control" id="satuan"
                                    aria-describedby="satuan" placeholder="Masukan satuan barang" required>
                            </div>
...
@push('scripts')
    ...
    <script>
        $(function() {
            $('form#tambah-stok-barang-form').validate({
                rules: {
